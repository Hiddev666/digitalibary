...
class User extends Controller
{
    ...
    public function cancelpending($bukuid) {
        session_start();
        $userid = $_SESSION["user-id"];

        $peminjaman = $this->getModel("Peminjaman_model")->cancelPending($userid, $bukuid);
        header("Location: " . BASEURL . "/user");
    }

    public function cancelpinjam($bukuid) {
        session_start();
        $userid = $_SESSION["user-id"];

        $peminjaman = $this->getModel("Peminjaman_model")->cancelPinjam($userid, $bukuid);
        header("Location: " . BASEURL . "/user");
    }
}
